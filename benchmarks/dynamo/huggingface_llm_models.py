...
class WhisperBenchmark(Benchmark):
    ...
    @staticmethod
    def model_iter_fn(runner_cls, model, inputs, collect_outputs=True):
        generation_kwargs = {
            "do_sample": False,
            "temperature": 0.0,
        }
        ...
        with runner_cls.autocast(**runner_cls.autocast_arg):
...
class TextGenerationBenchmark(Benchmark):
    ...
    def model_iter_fn(runner_cls, model, inputs, collect_outputs=True):
        generation_kwargs = {
            ...
            "max_length": TextGenerationBenchmark.OUTPUT_LENGTH,
            "temperature": 0.0,
